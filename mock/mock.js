...
var util = require("./util/fileUtil.js")


Mock.mock('http://127.0.0.1:3000/login',login)//登录
Mock.mock('http://127.0.0.1:3000/getOpro',newOpro)//首页新品
Mock.mock('/getIndexList',function(opt){
  console.log(indexList)
  return indexList
})//首页list
Mock.mock('http://127.0.0.1:3000/getBanner',banners)//首页banner
Mock.mock('http://127.0.0.1:3000/getMenu',menu)//首页menu
Mock.mock('http://127.0.0.1:3000/getHotSearch',hotSearch)//首页热搜

Mock.mock('http://127.0.0.1:3000/test', function(opt){
  util.readConfig("newOpro",function(res){
    console.log(res)
  })
})


Mock.mock('http://127.0.0.1:3000/product/details', // 商品详情数据
    {
        id: 'sddfsdf', //商品id
